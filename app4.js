...
const toggleEdit = (commentObject, commentBody) => {
  const editButton = commentBody.parentElement.querySelector(".edit");

  if (!commentObject.isEditing) {
    commentObject.isEditing = true;
    commentBody.setAttribute("contenteditable", true);
    commentBody.focus();
    editButton.textContent = "Save";
  } else {
    commentObject.isEditing = false;
    commentBody.setAttribute("contenteditable", false);
    editButton.textContent = "Edit";

    // Update the content of the commentObject
    commentObject.content = commentBody.textContent;
    initComments();
  }
};
...
const createCommentNode = (commentObject) => {
  ...
  const commentBody = commentNode.querySelector(".c-body");
  commentBody.textContent = commentObject.content; // Set the initial content
  ...
  commentNode.querySelector(".edit").addEventListener("click", () => {
    toggleEdit(commentObject, commentBody); // Pass the commentBody element
  });
...
function initComments(
  ...
  commentList.forEach((element) => {
    element.isEditing = false; // Initialize the isEditing property
...
// Add an event listener to the reply input "Send" button
